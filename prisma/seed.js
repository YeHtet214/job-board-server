...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        // Create users
        const employer1 = yield prisma.user.create({
            data: {
                email: 'employer@techcorp.com',
                passwordHash: yield (0, bcrypt_1.hash)('password123', 12),
                firstName: 'John',
                lastName: 'Smith',
        ...
        const employer2 = yield prisma.user.create({
            data: {
        ...
        const jobSeeker1 = yield prisma.user.create({
            data: {
                email: 'alice.dev@email.com',
                passwordHash: yield (0, bcrypt_1.hash)('password123', 12),
                firstName: 'Alice',
                lastName: 'Johnson',
                role: client_1.UserRole.JOBSEEKER,
                phone: '+1122334455',
                isEmailVerified: true,
            },
        });
        const jobSeeker2 = yield prisma.user.create({
            data: {
        ...
        const company2 = yield prisma.company.create({
            data: {
        ...
        // Create jobs
        const jobs = yield prisma.job.createMany({
            data: [
                {
                ...
                },
                {
                    ...
                    location: 'Remote',
                    type: client_1.JobType.CONTRACT,
                    salaryMin: 80000,
                    salaryMax: 100000,
        ...
        const createdJobs = yield prisma.job.findMany();
        console.log('Created jobs');
        // Create job applications
        yield prisma.jobApplication.createMany({
            data: [
                {
                ...
                },
                {
                    ...
                    acceptTerms: true,
                    status: client_1.ApplicationStatus.INTERVIEW,
                },
                {
                    jobId: createdJobs[2].id,
        ...
        // Create saved jobs
        yield prisma.savedJob.createMany({
            data: [
                {
                    jobId: createdJobs[0].id,
                    userId: jobSeeker1.id,
        ...
        // Create job views
        yield prisma.jobView.createMany({
            data: [
                {
                    jobId: createdJobs[0].id,
                    userId: jobSeeker1.id,
