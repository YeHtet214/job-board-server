 ...
 */
export const getSavedJobsHandler = async (req, res, next) => {
    try {
 ...
 */
export const saveJobHandler = async (req, res, next) => {
    try {
        const userId = req.user.userId;
 ...
 */
export const removeSavedJobHandler = async (req, res, next) => {
    try {
        const userId = req.user.userId;
 ...
 */
export const isJobSavedHandler = async (req, res, next) => {
    try {
        const userId = req.user.userId;
 ...
 */
export const batchCheckSavedJobsHandler = async (req, res, next) => {
    try {
        const userId = req.user.userId;
