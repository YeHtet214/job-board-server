...
profileRouter.post('/me', upload.any(), parseProfileFields, profileValidation.createProfile, validate,createProfile as RequestHandler);
profileRouter.put('/me',  upload.any(), parseProfileFields, profileValidation.updateProfile, validate, updateProfile as RequestHandler);
